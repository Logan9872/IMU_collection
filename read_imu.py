...
# par_device_addr = "6d:9f:6a:e9:cb:f0" # 设备的4MAC地址
...
class IMUThread(QThread):
    data_signal1 = pyqtSignal(object)
    ...
    def __init__(self, device_addr="59:7e:4b:aa:28:d4",priority=THREAD_PRIORITY_NORMAL):
    ...
    # def __init__(self, device_addr="6d:9f:6a:e9:cb:f0"):
        ...
        self.file_path = os.path.join('IMU_Data2', f'IMU_Data2_{start_time}.csv')
        self.initTime = 0
    ...
    async def ble_main(self):
        ...
        async with BleakClient(device, disconnected_callback=disconnected_callback) as self.client:
            ...
            params[2] = 20  # 静止归零速度(单位cm/s) 0:不归零 255:立即归零
    ...
    def parse_imu(self,buf):
        ...
        self.data_signal1.emit(imu_dat)
